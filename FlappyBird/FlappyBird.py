...
IMAGEM_CANO = pygame.transform.scale2x(pygame.image.load(os.path.join('imgs','pipe.png'))) #Imagem do cano
IMAGEM_CHAO = pygame.transform.scale2x(pygame.image.load(os.path.join('imgs','base.png'))) #Imagem do chão
IMAGEM_BACKGROUND = pygame.transform.scale2x(pygame.image.load(os.path.join('imgs','bg.png'))) #Imagem do fundo
IMAGENS_PASSARO = [
    pygame.transform.scale2x(pygame.image.load(os.path.join('imgs','bird1.png'))), #Imagem passaro 1
    pygame.transform.scale2x(pygame.image.load(os.path.join('imgs','bird2.png'))), #Imagem passaro 2
    pygame.transform.scale2x(pygame.image.load(os.path.join('imgs','bird3.png'))), #Imagem passaro 3
]
...
class Passaro:
    ...
    TEMPO_ANIMACAO = 5 #Tempo da animação do passaro
    ...
    #Calcular deslocamento
        ...
        deslocamento = 1.5 * (self.tempo**2) + self.velocidade * self.tempo #Formula: S = so +  vo . t + at² /2. (sorvetão)
...
#Cano:
class Cano:
    DISTANCIA = 200 #Distancia de um cano para o outro
...
#Chão:       
class Chao:
    VELOCIDADE = 5 #Velocidade do chão
